...
### Ссылки и код
- Внешние ссылки открываем в новой вкладке: `<a href="..." target="_blank" rel="noreferrer noopener">` или используем компонент `Link` из Docusaurus.
- Команды и файлы — в бэктиках. Длинные блоки оформляйте тройными кавычками с указанием языка (` ```bash `).
