...
- **Песочница**: страница `/wiki/example` показывает все доступные блоки. Жмите «Edit this page», чтобы открыть исходник и скопировать нужный фрагмент (изображение, admonition, таблицу). Это самый быстрый способ взять готовый шаблон.
