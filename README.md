...
- Дополнительные советы и FAQ для авторов — в `docs/wiki/wiki-docusaurus.mdx` (страница `/wiki/how-to-edit`).
- Наглядные примеры оформления (`/wiki/example` → файл `docs/wiki/example-page.mdx`): от таблиц до admonitions.
